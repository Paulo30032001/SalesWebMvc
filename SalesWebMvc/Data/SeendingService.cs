...
namespace SalesWebMvc.Data
{
    public class SeendingService
    {
        ...
        public SeendingService(SalesWebMvcContext _context)
        {
        ...
        public void Seed()
        {
            ...
            SalesRecord r3 = new SalesRecord(3, new DateTime(2018, 09, 13), 4000.0, SalesStatus.Cancelled, s4);
            ...
            SalesRecord r23 = new SalesRecord(23, new DateTime(2018, 10, 19), 11000.0, SalesStatus.Cancelled, s2);
            ...
            _context.SalesRecord.AddRange(r1, r2, r3, r4, r5, r6, r7, r8, r9, r10, r11, r12, r13, r14, r15, r16, r17, r8, r18, r19,
